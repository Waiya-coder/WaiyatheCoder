 ...
 * @author Pauline Nyandusi and WinnieBrenda Waiya
 */
public class CamPaint extends Webcam {
	...
	public void draw(Graphics g) {
		// TODO: YOUR CODE HERE
		// If display variable is 'w', draw live webcam image
		if (displayMode == 'w') {
			g.drawImage(image, 0, 0, null);
		}
		// If display variable is 'r', draw recolored image
		else if (displayMode == 'r') {
			g.drawImage(finder.getRecoloredImage(), 0, 0, null);
		}
		// If display variable is 'p', draw painting
